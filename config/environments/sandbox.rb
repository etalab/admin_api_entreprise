...
Rails.application.configure do
  ...
  config.token_renewal_url = 'https://sandbox.datapass.api.gouv.fr/copy-authorization-request/'
  config.token_authorization_request_url = 'https://sandbox.datapass.api.gouv.fr/api-entreprise/'
