...
Mailjet.configure do |config|
  config.api_key      = ::Rails.application.credentials.mj_apikey_public!
  config.secret_key   = ::Rails.application.credentials.mj_apikey_private!
  config.default_from = ::Rails.application.credentials.mj_default_from_email!
