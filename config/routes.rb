Rails.application.routes.draw do
  ...
  get '/cas_usages/marches_publics', to: 'cas_usages#show'
  get '/cas_usages/subventions', to: 'cas_usages#show'
  get '/cas_usages/fraude', to: 'cas_usages#show'
  get '/cas_usages/formulaire', to: 'cas_usages#show'
